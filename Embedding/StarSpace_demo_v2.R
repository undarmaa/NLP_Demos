...
# download.file("https://s3.amazonaws.com/fair-data/starspace/wikipedia_train250k.tgz",
#               "wikipedia_train250k.tgz")
# x <- readLines("wikipedia_train250k.tgz", encoding = "UTF-8")

x <- readLines("wikipedia_train250k.tgz", encoding = "ASCII")
...
x <- iconv( tolower(x), "latin1", "ASCII", sub="")
# install.packages('tm')
library(tm)


# x <- rm_stopwords(x, tm::stopwords("english"))
